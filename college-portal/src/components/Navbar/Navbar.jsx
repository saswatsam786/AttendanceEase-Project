...
import { IconSchool, IconChevronDown, IconSun, IconMoonStars, IconCircle } from "@tabler/icons";
...
export default function Navbar() {
  ...
  user?.email !== "gov@govindia.in" &&
    items.push(
      <>
        <Link key="QR-generator" to="/qr" className={classes.link}>
          QR-Generator
        </Link>
      </>
    );
  ...
  items.push(
    <Menu key="button" trigger="hover" exitTransitionDuration={0}>
      <Menu.Target>
        <ActionIcon variant="default" color="white" onClick={() => toggleColorScheme()} title="Toggle color scheme">
